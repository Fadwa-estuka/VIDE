...
public class VipsBlock {
	...
	private int VisualStructureNo =0;
	private VipsBlock aheadBlock=null;
	...
	public static Comparator<VipsBlock> VipsBlockComparator = new Comparator<VipsBlock>() {

		public int compare(VipsBlock b1, VipsBlock b2) {
		   int y=b1.getBox().getAbsoluteContentY()-b2.getBox().getAbsoluteContentY();
		   if(y==0)
			   return (b1.getBox().getAbsoluteContentX()-b2.getBox().getAbsoluteContentX());
		   else
			   return y;
	    }
	};
	
	public void setVisualStructureNo(int n){
		this.VisualStructureNo=n;
	}
	
	public int getVisualStructureNo(){
		return this.VisualStructureNo;
	}
	
	public void setAheadBlock(VipsBlock block){
		this.aheadBlock=block;
	}
	
	public VipsBlock getAheadBlock(){
		return this.aheadBlock;
	}
}
